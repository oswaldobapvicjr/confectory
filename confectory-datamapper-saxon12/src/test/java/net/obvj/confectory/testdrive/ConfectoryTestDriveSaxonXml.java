...
public class ConfectoryTestDriveSaxonXml
{
    public static void main(String[] args)
    {
     ...
     Configuration<XdmNode> config = Configuration.<XdmNode>builder()
     ...
     System.out.println(config.getString("//company[last()-1]/text()"));
     System.out.println(config.getString("//company[@id=8]"));
     System.out.println(config.getInteger("//company[1]/@id"));
     System.out.println(config.getString("//company[@id=10]/text()"));
    }
}
